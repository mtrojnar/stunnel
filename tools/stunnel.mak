...
PATH_2_SSL_INCLUDE=c:/tpsrc/openssl-0.9.7g/inc32/openssl
...
LINK32=link.exe
LINK32_FLAGS=wsock32.lib ssleay32.lib libeay32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\stunnel.pdb" /machine:I386 /out:"$(OUTDIR)\stunnel.exe" /pdbtype:sept /libpath:"c:/tpsrc/openssl-0.9.7g/out32dll"
LINK32_OBJS= \
	"$(INTDIR)\log.obj" \
	"$(INTDIR)\sthreads.obj" \
	"$(INTDIR)\client.obj" 
