/* version.h is generated from version.h.in by configure.  Edit version.h.in instead. */
...
#else /* __MINGW32__ */
#ifdef _MSC_VER
#define MSVC_VERSION_STRING0(a) #a
#define MSVC_VERSION_STRING(a) MSVC_VERSION_STRING0(a)
#define HOST PLATFORM "-pc-msvc-" MSVC_VERSION_STRING(_MSC_VER)
#else /* _MSC_VER */
