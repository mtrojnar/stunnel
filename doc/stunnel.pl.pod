...
aktualnie wspierane protoko³y: cifs, connect, nntp, pop3, smtp

=item B<protocolCredentials> = u¿ytkownik:has³o

dane uwierzytelniaj±ce do negocjacji protoko³u
