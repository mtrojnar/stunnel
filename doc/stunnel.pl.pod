...
katalog Urzêdu d/s Certyfikatów

Opcja okre¶la katalog, w którym stunnel bêdzie szuka³ certyfikatów,
...
=item B<setgid> = identyfikator_grupy

grupa z której prawami pracowa³ bêdzie I<stunnel>

=item B<setuid> = identyfikator_u¿ytkownika
...
weryfikuj certyfikat drugiej strony po³±czenia
    ...
    poziom 2 - weryfikuj z zainstalowanym
        certyfikatem Urzêdu d/s Certyfikatów
...
aktualnie wspierane protoko³y: smtp, pop3, nntp
...
W po³±czeniu z programem I<pppd> stunnel pozwala zestawiæ prosty VPN.
...
Przy generowaniu par certyfikat-klucz dla programu I<stunnel> istotne
...
I<stunnel> potrzebuje zainicjowaæ PRNG (generator liczb pseudolosowych),
gdy¿ protokó³ SSL wymaga do bezpieczeñstwa kryptograficznego ¼ród³a
dobrej dosowo¶ci.  Nastêpuj±ce ¼ród³a s± kolejno odczytywane a¿ do
...
¿e powinny byæ one inne przy ka¿dym uruchomieniu programu I<stunnel>.
