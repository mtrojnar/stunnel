...
B<chroot> keeps B<stunnel> in chrooted jail.  I<CApath>, I<pid> and I<exec>
...
On Unix: I<inetd> mode service name for TCP Wrapper library.
...
or I<tcpserver>) then you should read the section entitiled I<INETD MODE>
below.
